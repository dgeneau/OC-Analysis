...
def fetch_activity_details(client, activity_id):
    """Fetches detailed data for a specific activity."""
    try:
...
def flatten_activity_data(activity_details):
    """
    Flattens activity detail metrics into a clean DataFrame.
    """
...
def main():
    ...
    if activities:
        ...
        #data = pd.read_csv('testing_garmin.csv')
